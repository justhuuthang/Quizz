package com.hucework.quizzonline.controller;

import com.hucework.quizzonline.model.Question;
import com.hucework.quizzonline.repository.QuestionRepository;
import com.hucework.quizzonline.service.IQuestionService;
...
public class QuestionController {
    ...
    public ResponseEntity<Question> findQuestionById(@PathVariable Long id) throws ChangeSetPersister.NotFoundException {
    ...
    public ResponseEntity<List<Question>> getQuestionsForUser(@RequestParam Integer numOfQuestions, @RequestParam String subject){
        List<Question> allQuestion = questionService.getQuestionsForUser(numOfQuestions, subject);
